...
At the start time it opens a window above your other windows, takes focus, and a random `say` voice repeats "You have a call: <meeting title>" every 8 seconds until you dismiss it.
